    ...
    <div>
        ...
        <el-container>
            <el-header class="homeHeader">
                <el-switch v-model="isCollapse" inactive-color="#409eff"></el-switch>
                <div><i class="fa fa-users fa-2x" style="color: #ffffff"/>&nbsp; <font id="title">人事管理系统</font></div>
                <div style="display: flex; align-items: center; margin-right: 7px">
                    <el-dropdown trigger="click" style="margin-right:20px;">
                        <span class="el-dropdown-link">
                            <el-badge is-dot class="item">
                                <i class="fa fa-envelope " aria-hidden="true" style="cursor: pointer"/>
                            </el-badge>
                        </span>
                        <!-- <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item class="clearfix" style="margin-right: 8px">
                                <i class="fa fa-bell" aria-hidden="true"/>
                                系统通知
                                <el-badge class="mark" :value="108"/>
                            </el-dropdown-item>
                            <el-dropdown-item class="clearfix" style="margin-right: 8px">
                                <i class="fa fa-comments" aria-hidden="true"/>
                                好友讯息
                                <el-badge class="mark" :value="923"/>
                            </el-dropdown-item>
                        </el-dropdown-menu> -->
                    </el-dropdown>
            ...
            <el-container>
                <el-aside class="home-aside" :style="{width:leftclass}">
                        ...
                        <el-menu class="el-menu-vertical-demo" router unique-opened :collapse="isCollapse"
                            ...
                            <el-submenu :index="index+''" v-for="(item, index) in routes" :key="index"
                                ...
                                <el-menu-item :index="child.path" v-for="( child, indexj ) in item.children"
                                              :key="indexj">
                                    <i style="color: #409eff; margin:0 15px;" :class="child.iconcls"></i>
                ...
                <el-main>
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                        <el-breadcrumb-item :to="{ path: '/home' }" v-show=" this.$router.currentRoute.path!=='/home'">
                            首页
                        </el-breadcrumb-item>
                        <!--获取当前路由对象的指定属性-->
                        <el-breadcrumb-item>{{ this.$router.currentRoute.name}}</el-breadcrumb-item>
                    </el-breadcrumb>
                    <div :class="{homeRouterViewA: isa, homeRouterViewB: isb}" v-if="this.$router.currentRoute.path=='/home'">
